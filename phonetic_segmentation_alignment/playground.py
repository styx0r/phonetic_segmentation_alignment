...
FOLDER_MFA_OUTPUT='../data/mfa_output'
FOLDER_SPLIT_WAV='../data/mfa_input'

FOLDER_FINAL='../data/final'
...
for word, tg_files in textgrid_files.items():
    ...
    tgt.write_to_file(concatenated_tg, os.path.join(FOLDER_FINAL, word + "_concatenated.TextGrid"))